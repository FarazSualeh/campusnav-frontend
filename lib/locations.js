...
import { floor2Rooms, floor2RoomToNode } from "./floor2Data";
import { floor1Rooms, floor1RoomToNode } from "./floor1Data";
 ...
 * @property {string} category - "Lab" | "Classroom" | "Washroom" | "Admin" | "Entrance" | "staircase"
 ...
 * @property {string} floor - Floor identifier used to constrain same-floor routes
 */

// Special locations such as staircases and building access points
export const SPECIAL_LOCATIONS = [
  {
    id: "LOC-F1-FRONT-STAIRCASE",
    name: "Front Staircase (1st Floor)",
    category: "staircase",
    nodeId: "F1-N0",
    roomCode: "STAIRS",
    subtitle: "Main Entry / Exit Point • Floor 1",
    floor: "1",
  },
  {
    id: "LOC-F1-BACK-STAIRCASE",
    name: "Back Staircase",
    category: "staircase",
    nodeId: "F1-N12",
    roomCode: "BACK STAIRS",
    subtitle: "Back Staircase • Floor 1",
    floor: "1",
  },
  {
    id: "LOC-STAIRCASE-3",
    name: "Front Staircase (3rd Floor)",
    category: "staircase",
    nodeId: "N0",
    roomCode: "STAIRS",
    subtitle: "Main Entry / Exit Point • Floor 3",
    floor: "3",
  },
  {
    id: "LOC-BACK-STAIRCASE-3",
    name: "Back Staircase",
    category: "staircase",
    nodeId: "N30",
    roomCode: "BACK STAIRS",
    subtitle: "Back Staircase • Floor 3",
    floor: "3",
  },
  {
    id: "LOC-F2-FRONT-STAIRCASE",
    name: "Front Staircase (2nd Floor)",
    category: "staircase",
    nodeId: "F2-N0",
    roomCode: "STAIRS",
    subtitle: "Main Entry / Exit Point • Floor 2",
    floor: "2",
  },
  {
    id: "LOC-F2-BACK-STAIRCASE",
    name: "Back Staircase",
    category: "staircase",
    nodeId: "F2-S1",
    roomCode: "BACK STAIRS",
    subtitle: "Back Staircase • Floor 2",
    floor: "2",
  },
];
...
export function getLocations() {
  const toLocation = (room, doorNode, floor) => {
    ...
    return {
      ...
      nodeId: doorNode,
      roomCode,
      subtitle: `${room.category} • Floor ${floor}`,
      floor,
    };
  };

  const roomLocations = rooms.map((room) => toLocation(room, roomToNode[room.id] || "N0", "3"));
  const floor2Locations = floor2Rooms.map((room) => toLocation(room, floor2RoomToNode[room.id] || "F2-N0", "2"));
  const floor1Locations = floor1Rooms.map((room) => toLocation(room, floor1RoomToNode[room.id] || "F1-N0", "1"));

  return [...SPECIAL_LOCATIONS, ...roomLocations, ...floor2Locations, ...floor1Locations];
}

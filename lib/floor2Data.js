...
export const floor2Rooms = [
  ...
  { id: "F2-B320", label: "B-320 ECS Lab 4", x: 324, y: 180, w: 70, h: 150, category: "Lab" },
];
...
export const floor2Nodes = [
  ...
  // The back stair and the central corridor junctions are separate nodes.
  { id: "F2-S1", x: 333, y: 74, type: "Staircase", label: "Back Staircase" },
  // Central access for B-320, linking the top and bottom corridors directly.
  { id: "F2-I0", x: 315, y: 130, type: "Junction" }, { id: "F2-I3", x: 315, y: 255 },
  { id: "F2-I5", x: 315, y: 430, type: "Junction" },
];

export const floor2Edges = [
  // Outer perimeter, with one direct connection to the front staircase.
  ...
  // A single central corridor replaces the unused inner loop.

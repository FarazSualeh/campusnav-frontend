...
// Vertical connections are separate from same-floor corridor edges so they can
// be stored as building-level relationships when routing data moves to a backend.
export const stairConnections = [
  { from: "N0", to: "F2-N0", weight: 45, type: "stairs", fromFloor: "3", toFloor: "2" },
  { from: "N30", to: "F2-S1", weight: 45, type: "stairs", fromFloor: "3", toFloor: "2" },
  { from: "F1-N0", to: "F2-N0", weight: 45, type: "stairs", fromFloor: "1", toFloor: "2" },
  { from: "F1-N12", to: "F2-S1", weight: 45, type: "stairs", fromFloor: "1", toFloor: "2" },
];
...
export const rooms = [
  ...
  { id: "R-B409", label: "B-409 Seminar Hall", x: 234, y: 18, w: 64, h: 58, category: "Classroom" },
  { id: "R-BOYS",  label: "Boys Toilet",  x: 337, y: 18, w: 65, h: 58, category: "Washroom" },
  { id: "R-STAFF", label: "Staff Toilet", x: 402, y: 18, w: 42, h: 58, category: "Washroom" },
  { id: "R-SE",   label: "Software Engineering Lab", x: 450, y: 18, w: 80, h: 58, category: "Lab" },
  { id: "R-AI",   label: "Artificial Intelligence Lab", x: 535, y: 18, w: 80, h: 58, category: "Lab" },
  { id: "R-SYS",  label: "System Programing Lab", x: 621, y: 18, w: 98, h: 58, category: "Lab" },
  ...
  // Center
  { id: "R-LOUNGE", label: "Admin Lounge/Staff Room", x: 318, y: 140, w: 125, h: 195, category: "Admin" },
];
...
export const nodes = [
  ...
  { id: "N10", x: 670, y: 95 },                      // System Programing Lab door
  { id: "N11", x: 575, y: 95 },                      // Artificial Intelligence Lab door
  { id: "N12", x: 490, y: 95 },                      // Software Engineering Lab door
  { id: "N13", x: 423, y: 95 },                      // Staff Toilet door
  { id: "N14", x: 370, y: 95 },                      // Boys Toilet door
  { id: "N15", x: 266, y: 95 },                      // B-409 Seminar Hall door
  ...
  { id: "N30", x: 320, y: 95,  type: "Staircase" }, // Back staircase landing at the top loop
];

// Direct walkable corridor connections
export const edges = [
  // Top corridor (left to right): N18(49)→N19(85)→...→N15(266)→N27(315,jct)→N30(back stair)→N14(370)→...→N9(610)
  ["N18", "N19"], ["N19", "N17"], ["N17", "N16"], ["N16", "N15"], ["N15", "N27"],
  ["N27", "N30"], ["N30", "N14"], ["N14", "N13"], ["N13", "N12"], ["N12", "N11"], ["N11", "N10"], ["N10", "N9"],

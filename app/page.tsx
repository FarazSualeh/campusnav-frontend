...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Currently, Floors 1, 2 and 3 of the Engineering Building are fully mapped and live with interactive Dijkstra routing. Other campus blocks and the Ground floor remain upcoming.",
  },
  {
    ...
    <main id="top">
      ...
      <section className="hero">
        <nav className="nav shell" aria-label="Main navigation">
          ...
          <div className="nav-links">
            ...
            <Link href="/map" className="text-orange-600 font-bold">Live Floor 1, 2 &amp; 3 Maps</Link>
          </div>
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <Link className="button button-primary" href="/map">
                Explore Floor 1, 2 &amp; 3 Maps <Arrow />
              </Link>
            ...
            <div className="hero-note">
              <span className="status-dot" /> Live: Engineering Building (Floors 1, 2 &amp; 3)
            </div>
          </div>
      ...
      <section className="process section shell" id="how-it-works">
        ...
        <div className="process-grid">
          {[
            ["01", "Search", "Search for any classroom, lab, washroom or lounge on Floors 1, 2 and 3."],
        ...
        <div className="departments section shell">
          <div className="department-copy">
            ...
            <Link className="text-link" href="/map">
              Explore Floor 1, 2 &amp; 3 navigation <Arrow />
            </Link>
          </div>
          <div className="department-list">
            <div>
              <span>01</span>
              <b>Engineering</b>
              <small>Floors 1, 2 &amp; 3 Navigation Active</small>
            </div>
            <div>
              <span>02</span>
              <b>Pharmacy</b>
